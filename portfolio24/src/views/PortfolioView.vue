...
<template>
  <div class="bg-red-800 w-screen h-screen font-AndaleMo text-amber-100 pl-10 pt-20 pb-20 grid grid-cols-2  ">
    ...
    <div class="Portfolio col-span-1 text-sm">
      <RouterLink to="/">// PORTFOLIO</RouterLink> <!--THE ROUTERLINK TO GO HOOOOME :))-->
      <br> <br><br><br><br><br><br><br><br><br><br>
      <div>
        <h1 class="text-sm">RECENT WORK</h1>
        <br>                                              <!--THE <h1> AND <p> IS WRAPPED IN THE h1-div -->
          <p class="leading-loose text-sm">Here's a showcase of my recent work. You'll find anything from <br>
        ...
        <div class="flex flex-col justify-center text-center justify-around  "> 
          <!-- HERE WE GOT THE PORTFOLIO PROJECTS, THEY ARE WRAPPED IN THEIR OWN DIV-->
          
          <!-- Spm. Hvordan får jeg min line som krydser gennem min routerlink, til at ignore min text-color? -->
